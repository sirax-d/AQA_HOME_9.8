class Product:
    ...
    def buy(self, quantity):
        ...
        if self.check_quantity(quantity):
            ...
            raise ValueError(f"Вы можете купить {self.quantity} товаров")
...
class Cart:
    ...
    def add_product(self, product: Product, buy_count=1):
        ...
        if product in self.products:
            self.products[product] += buy_count  # увеличиваем количество
        else:
            self.products[product] = buy_count  # добавляем продукт в корзину
